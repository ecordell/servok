...
// Validate checks the field values on WatchRequest_KubeServiceRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, an error is returned.
func (m *WatchRequest_KubeServiceRequest) Validate() error {
	if m == nil {
		return nil
	}

	if len(m.GetService()) > 253 {
		return WatchRequest_KubeServiceRequestValidationError{
			field:  "Service",
			reason: "value length must be at most 253 bytes",
		}
	}

	if !_WatchRequest_KubeServiceRequest_Service_Pattern.MatchString(m.GetService()) {
		return WatchRequest_KubeServiceRequestValidationError{
			field:  "Service",
			reason: "value does not match regex pattern \"^[a-z0-9]([a-z0-9-\\\\.]{0,251}[a-z0-9])?$\"",
		}
...
// WatchRequest_KubeServiceRequestValidationError is the validation error
// returned by WatchRequest_KubeServiceRequest.Validate if the designated
// constraints aren't met.
type WatchRequest_KubeServiceRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e WatchRequest_KubeServiceRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e WatchRequest_KubeServiceRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e WatchRequest_KubeServiceRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e WatchRequest_KubeServiceRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e WatchRequest_KubeServiceRequestValidationError) ErrorName() string {
	return "WatchRequest_KubeServiceRequestValidationError"
}

// Error satisfies the builtin error interface
func (e WatchRequest_KubeServiceRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sWatchRequest_KubeServiceRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = WatchRequest_KubeServiceRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = WatchRequest_KubeServiceRequestValidationError{}

var _WatchRequest_KubeServiceRequest_Service_Pattern = regexp.MustCompile("^[a-z0-9]([a-z0-9-\\.]{0,251}[a-z0-9])?$")
